...
Built-in web server. Developed by Anna Svensson.
...
You can start a web server at the [command line](https://github.com/annaesvensson/yellow-core). The built-in web server is convenient for developers and designers. This allows you to edit your website on your computer and upload it to your web server later. Open a terminal window. Go to your installation folder, where the file `yellow.php` is. Type `php yellow.php serve`, you can optionally add a URL. Open a web browser and go to the URL shown.
